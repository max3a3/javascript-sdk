...
/** @lends AV.Leaderboard.prototype */{
  ...
  _getResults: function _getResults(_ref6, authOptions, self) {
    ...
    return request({
      method: 'GET',
      path: '/leaderboard/leaderboards/' + this.statisticName + '/ranks' + (self ? '/self' : ''),
      query: {
        skip: skip,
        limit: limit,
  ...
  getResultsAroundUser: function getResultsAroundUser() {
    var _ref9 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
        limit = _ref9.limit,
        selectUserKeys = _ref9.selectUserKeys,
        includeStatistics = _ref9.includeStatistics,
        version = _ref9.version;

    var authOptions = arguments[1];

    return this._getResults({ limit: limit, selectUserKeys: selectUserKeys, includeStatistics: includeStatistics, version: version }, authOptions, true);
  },
  ...
  getArchives: function getArchives() {
    ...
    return request({
      ...
      return results.map(function (_ref12) {
        var version = _ref12.version,
            status = _ref12.status,
            url = _ref12.url,
            activatedAt = _ref12.activatedAt,
            deactivatedAt = _ref12.deactivatedAt;
        return {
